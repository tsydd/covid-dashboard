...
import dashboard.components.DataTable
import dashboard.components.DataTableDispatchProps
import dashboard.components.DataTableProps
import dashboard.components.DataTableStateProps
...
private val getEntries: (State) -> Array<TableEntry> =
    createSelector(
        { state -> state.keyFilter.lowercase() },
...
val dataTable: ComponentClass<Props> =
    rConnect<State, RAction, WrapperAction, Props, DataTableStateProps, DataTableDispatchProps, DataTableProps>(
        { state, _ ->
    ...
    )(DataTable::class.js.unsafeCast<ComponentClass<DataTableProps>>())
